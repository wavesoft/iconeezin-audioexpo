...
/***/ function(module, exports, __webpack_require__) {
	...
	var IconVR = __webpack_require__(169);
	var IconDesktop = __webpack_require__(282);
	var IconExclamation = __webpack_require__(283);

	var Viewport = __webpack_require__(284);
	var Welcome = __webpack_require__(287);
	var ErrorMessage = __webpack_require__(288);
	var MessagePanel = __webpack_require__(289);
	...
	var IconeezinRoot = React.createClass({
	  ...
	  * Event handlers
	  */
		handleVRChange: function handleVRChange(isSupported, hmdDevice) {
	  ...
	  */
		getErrorMessage: function getErrorMessage() {
			return React.createElement(
				"div",
				{ className: "icnz-error-frame" },
				React.createElement(
					"div",
					{ className: "icnz-part-icon" },
					React.createElement(IconExclamation, null)
				),
				React.createElement(
					"div",
					{ className: "icnz-part-content" },
					React.createElement(
						"h4",
						null,
						"Ανεπανόρθωτο σφάλμα"
		...
		getStartMessage: function getStartMessage() {
			...
			return React.createElement(
				...
				React.createElement(
					"div",
					null,
					"Καλωσήρθατε στην έκθεση ακουστικών πειραμάτων. Για τη βέλτιστη εμπειρία σας, προτείνεται να χρησιμοποιήσετε τον πλοηγό Google Chrome."
				),
				React.createElement(
					"div",
	 ...
	 */
	ReactDOM.render(React.createElement(IconeezinRoot, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var helpers = __webpack_require__(170)(__webpack_require__(39));
	...
	module.exports = React.createClass({
	    ...
	    getDefaultProps: function getDefaultProps() {
	        return { "version": "1.1", "baseProfile": "tiny", "id": "Layer_1", "xmlns": "http://www.w3.org/2000/svg", "data-svgreactloader": "[[\"http://www.w3.org/2000/svg\",\"xlink\",\"http://www.w3.org/1999/xlink\"],[\"http://www.w3.org/2000/svg\",\"space\",\"preserve\"]]", "x": "0px", "y": "0px", "width": "32px", "height": "32px", "viewBox": "0 0 32 32", "overflow": "inherit" };
	    },
	    componentDidMount: function componentDidMount() {
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'svg',
	            this.props,
	            React.createElement('path', { fill: '#999999', d: 'M26.541,8.122H5.494c-1.463,0-2.647,1.185-2.647,2.648v9.059c0,1.464,1.185,2.649,2.647,2.649h7.631\r l1.743-3.137c0.522-0.872,1.777-0.872,2.265,0l1.742,3.137h7.63c1.464,0,2.648-1.186,2.648-2.649v-9.059\r C29.188,9.307,28.004,8.122,26.541,8.122z M10.024,18.47c-1.777,0-3.206-1.427-3.206-3.205c0-1.777,1.428-3.206,3.206-3.206\r c1.777,0,3.206,1.429,3.206,3.206C13.23,17.043,11.801,18.47,10.024,18.47z M21.697,18.47c-1.777,0-3.207-1.427-3.207-3.205\r c0-1.777,1.43-3.206,3.207-3.206c1.776,0,3.204,1.429,3.204,3.206C24.901,17.043,23.474,18.47,21.697,18.47z' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forEach  = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLikeObject = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(250),
	    ...
	    baseGetTag = __webpack_require__(254),
	    toSource = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsTypedArray = __webpack_require__(256),
	    baseUnary = __webpack_require__(257),
	    nodeUtil = __webpack_require__(258);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLength = __webpack_require__(185),
	    isObjectLike = __webpack_require__(186);
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'g',
	                null,
	                React.createElement('path', { fill: '#999999', d: 'M20.553,24.944H10.449c-0.508,0-0.918,0.412-0.918,0.919s0.41,0.919,0.918,0.919h10.104\r c0.508,0,0.919-0.412,0.919-0.919S21.061,24.944,20.553,24.944z' }),
	                React.createElement('path', { fill: '#999999', d: 'M26.639,3.817H4.364c-0.952,0-1.723,0.772-1.723,1.723v15.846c0,0.951,0.771,1.722,1.723,1.722h22.274\r c0.951,0,1.722-0.771,1.722-1.722V5.54C28.36,4.589,27.59,3.817,26.639,3.817z M26.523,19.434H4.478V5.655h22.046V19.434z' })
	            ),
	            React.Children.map(children, function (c) {
	                return c;
	            })
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'svg',
	            this.props,
	            React.createElement('path', { fill: '#FFC107', d: 'M24.342,5.66l-8.843-2.197L6.655,5.66C5.599,5.917,4.858,6.858,4.886,7.942v11.554\r c0,0.685,0.286,1.312,0.798,1.769l8.273,7.274c0.884,0.771,2.225,0.771,3.109,0l8.273-7.274c0.514-0.456,0.799-1.084,0.799-1.769\r V7.942C26.111,6.858,25.397,5.917,24.342,5.66z M15.499,22.149c-0.97,0-1.769-0.799-1.769-1.769c0-0.971,0.799-1.77,1.769-1.77\r c0.971,0,1.77,0.799,1.77,1.77C17.269,21.351,16.469,22.149,15.499,22.149z M17.269,12.421c-0.059,0.285-0.201,0.742-0.401,1.312\r c-0.285,0.856-0.485,1.512-0.57,2.025c-0.114,0.485-0.172,0.97-0.2,1.483c0,0.172-0.028,0.371-0.142,0.514\r c-0.085,0.114-0.257,0.172-0.399,0.143c-0.114,0-0.257-0.028-0.342-0.114c-0.086-0.113-0.143-0.285-0.143-0.428\r c-0.029-0.399-0.057-0.685-0.086-0.856c-0.028-0.171-0.085-0.428-0.171-0.799c-0.143-0.57-0.342-1.169-0.571-1.825\r c-0.285-0.771-0.457-1.284-0.514-1.569c-0.085-0.313-0.114-0.627-0.114-0.941c0-0.514,0.171-1.027,0.513-1.426\r c0.343-0.428,0.856-0.685,1.398-0.656c0.514,0,0.999,0.228,1.312,0.627c0.371,0.457,0.542,1.027,0.513,1.626\r C17.353,11.851,17.324,12.136,17.269,12.421z' }),
	            React.Children.map(children, function (c) {
	                return c;
	            })
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Iconeezin = __webpack_require__(1);
	var HADE = __webpack_require__(285);
	var React = __webpack_require__(2);
	...
	module.exports = React.createClass({
	  ...
	  */
		componentDidMount: function componentDidMount() {
			...
			// Handle messages
			Iconeezin.Runtime.Video.setMessageHandler(function (message) {
				if (message === null) {
					_this.setState({
						'hade_visible': false
					});
			...
			// Handle title
			Iconeezin.Runtime.Video.setInteractionHandle(function (message) {
				if (message === null) {
					_this.setState({
						'title_visible': false
					});
	  ...
	  * is destroyed.
	  */
		componentWillUnmount: function componentWillUnmount(dom) {
	  ...
	  * Hide HADE
	  */
		'handleHideGreeter': function handleHideGreeter() {
			this.setState({
				'hade_visible': false
			});
		},
	  ...
	  */
		render: function render() {
			return React.createElement(
				"div",
				{ className: "icnz-viewport", ref: "viewport" },
				React.createElement("div", { className: "icnz-canvas", ref: "canvas" }),
				React.createElement(
					"div",
					{ className: "icnz-interaction-title" + (this.state.title_visible ? " visible" : "") },
					React.createElement(
						"span",
						null,
				...
				React.createElement("div", { id: "debug-window" }),
				React.createElement(HADE, { hmd: this.props.hmd,
	...
	var HADEContent = React.createClass({
	  ...
	  */
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'icnz-hade-content' },
				React.createElement(
					'div',
					{ className: 'icnz-hade-center-pane' },
					React.createElement(
						'h1',
						null,
						this.props.title
	...
	module.exports = React.createClass({
	  ...
	  */
		render: function render() {
			...
			return React.createElement(
				'div',
				{ ref: 'host', style: sizeStyle, className: "icnz-hade" + (this.props.hmd ? " icnz-hade-hmd" : "") + (this.props.visible ? " visible" : "") + " icnz-hade-type-" + this.props.type },
				React.createElement(
					'div',
					{ className: 'icnz-hade-left', style: sizeStyle },
					React.createElement(HADEContent, { title: this.props.title, body: this.props.body })
				),
				React.createElement(
					'div',
					{ className: 'icnz-hade-right', style: sizeStyle },
					React.createElement(HADEContent, { title: this.props.title, body: this.props.body })
				)
			);
		}
...
/***/ function(module, exports) {
	...
	module.exports = Iconeezin.Libraries.jquery;
	...
	module.exports = React.createClass({
	  ...
	  */
		render: function render() {
			return React.createElement(
				'div',
				{ className: "icnz-welcome-host" + (this.props.visible ? " visible" : "") },
				React.createElement(
					'div',
					{ className: 'icnz-welcome-panel' },
					React.createElement(
						'div',
						{ className: 'icnz-welcome-body' },
						React.createElement(
							'h1',
							null,
							'Virtual Audio Exhibition'
						),
						React.createElement(
							'p',
							null,
							'Please click the following button to start your experience. If your browser supports WebVR you have the option to start in Virtual Reality.'
						)
					),
					React.createElement(
						'div',
						{ className: 'icnz-welcome-buttons' },
						React.createElement(
							'button',
							{ className: this.props.hasvr ? "" : "visible", type: 'button', onClick: this.props.onStartDesktop },
							React.createElement(IconDesktop, null),
							' Start Desktop Experience'
						),
						React.createElement(
							'button',
							{ className: this.props.hasvr ? "visible" : "", type: 'button', onClick: this.props.onStartHMD },
							React.createElement(IconVR, null),
							'  Start VR Experience'
						)
					)
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'icnz-welcome-panel icnz-error' },
	        React.createElement(
	          'div',
	          { className: 'icnz-welcome-body' },
	          React.createElement(
	          ...
	          React.createElement(
	            ...
	            null,
	            React.createElement(IconExclamation, null),
	            ' The exchibition was unable to start due to an unrecoverable error.'
	          ),
	          React.createElement(
	            'p',
	            { className: 'icnz-error-frame' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "icnz-message-panel" + (this.props.visible ? " visible" : "") },
	      React.createElement(
	        "div",
	        { className: "icnz-message-panel-frame" },
	        React.createElement("div", { className: "icnz-part-logo" }),
	        React.createElement(
	          "div",
	          { className: "icnz-part-header" },
	          this.props.title
	        ),
	        React.createElement(
	          "div",
	          { className: "icnz-part-body" },
	          this.props.children
	        ),
	        React.createElement(
	          "div",
	          { className: "icnz-part-version" },
	          this.props.version
	        )
	      )
	    );
...
/***/ function(module, exports) {
	...
	module.exports = {
		"name": "iconeezin-audioexpo",
		"version": "1.1.5",
		"description": "An audio experimentation VR world",
		"main": "index.js",
		"scripts": {
			"test": "echo \"Error: no test specified\" && exit 1",
			"live": "NODE_ENV=debug gulp live",
			"dist": "npm version patch && NODE_ENV=production gulp && git commit -a -m \"Build $(cat package.json | grep '\"version\":' | awk -F': ' '{print $2}' | tr -d '\",')\""
		},
		"repository": {
			"type": "git",
			"url": "git+https://github.com/wavesoft/iconeezin-audioexpo.git"
		},
		"keywords": [
			"iconeezin",
			"vr",
		...
		"license": "Apache-2.0",
		"bugs": {
			"url": "https://github.com/wavesoft/iconeezin-audioexpo/issues"
		},
		"homepage": "https://github.com/wavesoft/iconeezin-audioexpo#readme",
		"devDependencies": {
			"babel-core": "^6.9.1",
			"babel-loader": "^6.2.4",
