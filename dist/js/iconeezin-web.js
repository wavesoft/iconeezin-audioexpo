	  ...
	  */
		render: function render() {
			return React.createElement(
				...
				React.createElement(Viewport, { experiment: this.state.experiment, paused: this.state.paused, hmd: this.state.hmd }),
				React.createElement(Welcome, { hasvr: this.state.hasvr, visible: this.state.paused, onStartDesktop: this.handleStartDesktop, onStartHMD: this.handleStartHMD })
			);
		}
