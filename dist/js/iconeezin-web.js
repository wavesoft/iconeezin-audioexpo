	  ...
	  */
		render: function render() {
			return React.createElement(
				...
				React.createElement(Welcome, { visible: this.state.paused, onStartDesktop: this.handleStartDesktop, onStartHMD: this.handleStartHMD })
			);
		}
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							"p",
							null,
							"Please select one of the following modes to start your experience. It will open in full screen."
						)
					),
					React.createElement(
						"div",
						...
						React.createElement(
							"button",
							{ type: "button", onClick: this.props.onStartDesktop },
						...
						React.createElement(
							"button",
							{ type: "button", onClick: this.props.onStartHMD },
							React.createElement("span", { className: "entypo-eye" }),
							" Occulus VR Mode"
						)
					)
				)
